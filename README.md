...
vkTF (VK Transmission Format) is a royalty-free specification for the efficient transmission and loading of 3D scenes and models by applications. vkTF minimizes both the size of 3D assets, and the runtime processing needed to unpack and use those assets. vkTF defines an extensible, common publishing format for 3D content tools and services that streamlines authoring workflows and enables interoperable use of content across the industry.

## Specification

* [vkTF Specification, 1.0](specification/1.0/README.md) (or [all specification versions](specification/README.md))
* [vkTF Extension Registry](extensions/README.md)
...
<p align="center">
<a href="specification/2.0/figures/gltfOverview-2.0.0a.png"><img src="specification/1.0/figures/gltfOverview-2.0.0a-small.png" /></a>
